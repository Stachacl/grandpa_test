export declare const VOICE_RSS_URL = "api.voicerss.org";
export declare const METHOD = "POST";
export declare const HEADER_NAME = "Content-Type";
export declare const HEADER_VALUE = "application/x-www-form-urlencoded; charset=UTF-8";
export declare const ERROR_PREFIX = "ERROR: ";
export declare enum VoiceRSSError {
